...
class Level2:
    ...
    def win_screen(self):
        ...
        self.draw_text('Вы прошли на финальный уровень!', win_font, m.GREEN, 150, 220)
        next_level_font = pygame.font.SysFont(None, 36)
        self.draw_text('Нажмите на Enter для продолжения', next_level_font, m.WHITE, 180, 320)
        pygame.display.flip()
        waiting = True
        while waiting:
    ...
    def show_start_screen(self):
        ...
        self.draw_text('Пирамида. Уровень 2', text_font, m.WHITE, 270, 250)
